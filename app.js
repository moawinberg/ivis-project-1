...
var colors = {
  "Media Technology": [185, 56, 73],
  "Computer Science": [318, 65, 67],
  "Human-Computer Interaction": [8, 100, 52],
  "Graphic Design": [30, 100, 73],
  "Information and Network Engineering": [110, 57, 70],
  "Mathematics, Statistics": [10, 30, 42],
  "Visual Computing": [204, 70, 41],
};
...
d3.csv("data/data2.csv", function (raw_data) {
...
function data_table(sample) {
  ...
  var table = d3.select("#student-list")
    .html("")
    .selectAll(".row")
    .data(sample)
    .enter().append("div")
...
function highlight(d) {
  ...
  if (d.interests.length > 0) {
    document.getElementById("quote").innerHTML = '"' + d.interests + '"';
  }
}
...
function paths(selected, ctx, count) {
  ...
  data_table(selected.slice(0, 100));
